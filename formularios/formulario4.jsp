...
<form class="needs-validation"novalidate>
							...
							<div class="form-group col-md-10">
								<label for="inputPassword4">Cantidad producto</label>
								<input type="text" class="form-control" id="inputtalla" required="">
								<div class="valid-feedback">
								Es valido
							</div>
						...
						<div class="form-group col-md-10">
							<label for="inputPassword4">color producto</label>
							<input type="text" class="form-control" id="inputtalla" required="">
							<div class="valid-feedback">
								Es valido
							</div>
        ...
        <option>Hombre</option>
         <option>Mujer</option>
					...
					<div class="col">
						...
						<button  class="btn btn-primary" type="submit" id="#exampleModal">Elimiar</button>
